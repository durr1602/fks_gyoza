...
# with the --no-temp flag
all_mut = pd.read_csv("../../config/project_files/expected_mut/FKS1-HS1.csv.gz")[["Mutated_seq", "WT_seq", "nt_seq"]]
...
pd.concat([df, silent]).to_csv("../FKS1-HS1.csv.gz", index=False)

# The file is then moved in the appropriate folder to start gyoza with the 'provided' mode